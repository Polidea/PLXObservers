#import <PLXObservers/PLXObservers.h>
#import "ChatUser.h"

SPEC_BEGIN(PLXObserversSpec)

describe(@"PLXObservers", ^{
    __block PLXObservers <ChatServiceProtocol> *chatService;
    __block ChatUser *powerUser;
    __block NSString *filePath;

    beforeEach(^{
        chatService = (PLXObservers <ChatServiceProtocol>*)[[PLXObservers alloc] initWithObserverProtocol:@protocol(ChatServiceProtocol)];
